...
public class RecommendationInteranlService {
  ...
  public CompletableFuture<RecommendationDto> getRecommendationsByLLM(UUID weatherId, UUID userId) {
    // 날씨, 유저 정보 추출
  ...
  @Async("recommendationExecutor")
  public CompletableFuture<RecommendationDto> getRecommendationsByCustomAlgorithm(UUID weatherId,
    UUID userId) {
